"""
HollowKnight/Silksong 环境专用训练脚本
...
def build_hk_env(image_size, seed, env_name: str):
    ...
    """
    # 根据 env_name 选择具体环境，默认 HollowKnight
...
if __name__ == "__main__":
    ...
    parser.add_argument("-env_name", type=str, default="HollowKnight",
                        help="Environment name: HollowKnight or HollowKnight_Silksong")
    ...
    if conf.Task == "JointTrainAgent":
        # 定义action_dim
        if args.env_name == "HollowKnight_Silksong":
            action_dim = 256
        elif args.env_name == "HollowKnight":
            action_dim = 128
        else:
